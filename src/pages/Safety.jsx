...
export default function Safety() {
  ...
  return (
    <div className='w-[100%]'>
        <video loop autoPlay muted className='relative brightness-50 saturate-150 sm:w-full'>
        <source src="./safety.mp4" type='video/mp4' />
        </video>
        
        <div className='absolute top-[70%] '>
          <h2 className='text-6xl text-white mt-16 font-semibold'>
              Safety
          </h2>
          <p className='text-3xl text-white font-thin text-center mt-8 pb-24'>
        ...
        <div className='bg-gradient-to-r from-[#ffffff] to-[#cebfaf] py-14'>
          <div className='justify-center flex space-x-52'>
            <div>
              ...
              <h2 className=' mt-4 text-5xl font-semibold text-[#cc2952]'>Covid-19</h2>
            </div>
        ...
        <h2 className='text-6xl font-extralight text-center mt-14'>Safety Instructions</h2>
        <p className='text-3xl font-thin text-slate-500 text-center mt-9'>
          Please Read our safety instructions for much safer rides.
        </p>

        <div className='flex justify-center mt-12 space-x-20 mb-16'> 
          <div>
            <img src="https://luxorides.com/assets/images/luxorides-luxorides-luxury-car-rentals-for-wedding-corporate-personal-delhi-noida-gurgaon-ghaziabad-1-846x1063.webp" alt="" className='w-[450px]'/>
          </div>
          <div>
            ...
            <p className='text-lg text-slate-500 mt-4'>
              A seat belt should be on before the car moves, and should stay on until<br/> the engine is turned off at your destination.
            </p>
            ...
            <h2 className='text-2xl font-semibold mt-10'>
              3.  Ride kids in the backseat.
            </h2>
            <p className='text-lg text-slate-500 mt-4'>
              Kids younger than 12 should always ride in the backseat. Passenger-side air<br/> bags, designed to protect a person with a much bigger body, can<br/> seriously injure a small child.
            </p>
            ...
            <p className='text-lg text-slate-500 mt-4'>
            Passengers need to understand the importance of staying calm and low-key<br/> in their seats. If they are disturbing or the kids are jumping around or yelling, it<br/> can distract the driver and put all the passengers at risk.
            </p>
          </div>
        </div>
