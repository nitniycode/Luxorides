    ...
    <section>
      <div >
        ...
        <div className='absolute top-80 left-[28%] text-center'>
          ...
          <h2 className='text-7xl text-white font-semibold'><span className='font-semibold'>Luxury Cars</span> In <span className='font-semibold'>Jaipur</span></h2>
        </div>
      </div>
      <div >
        ...
        <div>
                ...
                <p className=' m-auto text-2xl text-center font-extralight'>
                        Renting a luxury car in a city like Jaipur is much of a<br/>
