    ...
    <section>
      <div >
        ...
        <div className='absolute top-52 right-44 text-right'>
          ...
          <h2 className='text-7xl text-[#c1c1c1] font-thin'>In <span className='font-semibold'>Delhi</span></h2>
        </div>
      </div>
      <div >
        ...
        <p className='text-center mt-3 text-7xl font-light'>
          a Luxury Car for <span className='font-medium'>Delhi?</span>
        </p>
        ...
        <div>
                <p className='text-center mt-48 text-5xl font-light mb-[30px] '>
                      Renting a luxury car in <span className='font-medium'>Delhi</span>
                </p>
                <p className=' m-auto text-2xl text-center font-extralight'>
                        Renting a luxury car in a city like Delhi is much of a<br/>
