                    ...
                    <div className=' p-5 mt-7 text-center'>
                        ...
                        <p className='text-lg font-thin mt-6 text-white'>Please fill in the information below:</p>
                            ...
                            <form>
                                <input
                                    type='text' 
                                    className='w-full h-9 border-2 border-gray-400 py-5 mt-4'
                                    placeholder='First name'
                                />
                                <input 
                                    type='text'
                                    className='w-full h-9 border-2 border-gray-400 py-5 mt-6'
                                ...
                                <button className='text-white w-full my-5 py-2 rounded-md bg-[#073b4c]'>SIGN UP</button>
