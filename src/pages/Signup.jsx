...
export default function Signup() {
  return (
    <section>
        <div>
            <img src="./sign3.jpg" alt="signupimage"
            className='relative' 
            />
            ...
            <div className='absolute top-16 right-1 '>
                <div className='mx-[150px] hover:shadow-2xl'>
                    <div className=' p-5 mt-7 text-center'>
                        ...
                        <p className='text-lg font-thin mt-6 text-white'>Please fill in the information below:</p>
                        
                            <form className=' w-[500px]'>
                                <input
                                    type='text' 
                                    className='w-full h-9 border-2 border-gray-400 px-2 py-5 mt-4'
                                    placeholder='First name'
                                />
                                <input 
                                    type='text'
                                    className='w-full h-9 border-2 border-gray-400 px-2 py-5 mt-6'
                                ...
                                <div className='flex justify-between mt-2'>
                                    <p className='font-thin text-white'>Already Have An Account?<Link to='/signin' className='font-semibold text-red-600'> Login </Link></p>
                                    
                                </div>
                                <button className='text-white w-full my-5 py-2 rounded-md bg-[#073b4c]'>CREATE MY ACCOUNT</button>
