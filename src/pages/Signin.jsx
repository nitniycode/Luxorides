    ...
    <section>
        <div>
            ...
            <div className='absolute top-32 right-12 '>
                <div className='bg-[#ccf5f4] mx-[150px] hover:shadow-2xl'>
                    <div className=' p-5 mt-7 text-center'>
                        <h2 className='text-4xl font-bold'>Sign In</h2>
                        <p className='text-lg font-thin mt-6'>Please enter your e-mail and password:</p>
                            ...
                            <form>
                                ...
                                <div className='flex justify-between mt-2'>
                                    <p className='font-thin'>Don't Have An Account?<Link to='/sign-up' className='font-semibold text-red-600'> Create one</Link></p>
                                    <Link to='/' className='font-semibold text-blue-500'>Forgot Password?</Link>
                                </div>
